Public Class CEOApproval
    Dim idToUp = 0
    Dim op = 0
    Private Sub CEOApproval_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub TabControl1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles TabControl1.SelectedIndexChanged
        ...
        If TabControl1.SelectedTab.Name = "TabPageApproved" Then
            Me.LoanApprovalTableAdapter1.FillForCEOAprr(Me.employeDataSet1.loanApproval)
            op = 2
        End If
    End Sub
